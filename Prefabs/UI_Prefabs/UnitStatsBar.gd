...
func update_stats(unit: Unit) -> void:
	...
	health_text_label.text = "Health: %d / %d" % [unit.attribute_map.get_attribute_by_name("health").current_value, unit.attribute_map.get_attribute_by_name("health").maximum_value]
