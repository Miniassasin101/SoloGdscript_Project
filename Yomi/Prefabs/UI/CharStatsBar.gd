class_name CharStatsBar
extends MarginContainer

@export var unit_stats_bar_content: PanelContainer

@export var unit_name_label: Label
@export var beats_until_actionable_label: Label
...
func update_stats(unit: BaseChar) -> void:
	...
	beats_until_actionable_label.set_text(str(unit.state_machine.beats_until_actionable))
	...
	if !ActionabilityTracker.instance.is_unit_actionable(unit):
		if unit.is_enemy:
